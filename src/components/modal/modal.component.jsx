...
export const Modal = ({ isShowing, hide }) => {
  ...
  const classes = {
    ...
    modal: 'relative z-30 bg-white rounded-sm h-2/5 mb-44 w-1/6',
    modalHeader: 'flex justify-between items-center h-1/4 bg-blue-light-300 py-4 pr-4 pl-8 text-blue-dark',
    modalCloseButton: 'flex items-center justify-center self-start w-6 h-6 text-xl font-light bg-white cursor-pointer rounded-full border-none',
